...
depress_color = 
  c("Depressed" = ggsci::pal_npg()(n=9)[8],
    "Not Depressed" = ggsci::pal_npg()(n=9)[2]) 

entero_color = 
  c("Bacteroides" = ggsci::pal_lancet()(n=9)[3],
    "Ruminococcus" = ggsci::pal_lancet()(n=9)[1],
    "Prevotella" = ggsci::pal_lancet()(n=9)[5])

entero_color_1 =
  c("1" = ggsci::pal_lancet()(n=9)[3],
    "2" = ggsci::pal_lancet()(n=9)[1],
    "3" = ggsci::pal_lancet()(n=9)[5])
